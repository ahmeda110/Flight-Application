...
Passenger::Passenger(const string firstN, const string lastN, const string phoneN, const int seatN, const char seatL, const int id){
	first_name = firstN;
	last_name = lastN;
	phone_number = phoneN;
...
void Passenger::setSeatDetails(const int seatN, const char seatL)
{
